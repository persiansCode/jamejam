  ...
  <x-cms.sidebar/>
        ...
        <div class="col-span-12 md:col-span-10 pb-10">
            <div class="flex w-full items-center mt-10 md:mt-38 md:justify-start justify-center pl-0 pr-0 md:pr-5">
                <button class="btn bg-yellow-400  w-[80%] md:w-[20%] rounded-md p-2">بازگشت به صفحه اصلی</button>
            ...
            <div class=" ml-8  md:ml-18 ">
                <form id="form" wire:submit="submit" method="post" enctype="multipart/form-data">
                    <div class="w-full flex flex-col md:flex-row items-center justify-center mt-10  gap-6">
                        <div class="w-full">
                            <p class="text-white pr-4 text-sm ">عنوان</p>
                            <input type="text" wire:model="title" name="title" 
                                class="input input-md border-[2px] border-slate-400 rounded-md p-2 m-5 outline-none w-full text-white placeholder-white "
                ...
                @enderror
                        ...
                        <div class="w-full ">
                            <p class="text-white pr-4 text-sm ">وضعیت</p>

                            <select wire:model="status" name="status"  class="w-full border-[2px] text-white border-slate-400 m-5 p-2 rounded-md">
      ...
      <div class="w-full flex items-center justify-center mt-3 gap-6">
                        <div class="w-full">
                            <p class="text-white pr-4 text-sm ">عکس</p>
                ...
                @enderror
                       ...
                       <div class="w-full flex items-center justify-center mt-3 gap-6">
                        <div class="w-full">
                            <p class="text-white pr-4 text-sm ">توضیحات دسته بندی</p>
                ...
                <button class="btn bg-red-500  rounded-md p-3 w-full m-4"> ثبت  </button>
